# SHORT 20 — Serverless de container
...
- **Titulo Short:** Serverless de container
- **Caption:** Sem servidor pra gerenciar, paga só por requisição. | Cloud Run sobe seu Docker e escala de 0 a milhares. 2 cliques. | PDF de apoio R$ 4,95 cupom **CUPOM50** | Trilha completa R$ 39,99 cupom **SEGUIDOR80** | @devopsraiz | #devopsraiz #devops #cloud #devjr #carreiratech
- **Trilha sonora:** lo-fi tech trending 60-90 BPM
- **Texto na tela (overlay):**
    - 0:00-0:03 — "Sem servidor pra gerenciar, paga só por requisição." (white sobre dark, font bold)
