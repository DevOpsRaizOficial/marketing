...
- **Titulo Short:** Kubernetes sem dor
- **Caption:** Kubernetes assusta? Pensa numa orquestra de músicos. | Pod = músico. Deployment = partitura. Kubectl = maestro. | PDF de apoio R$ 4,95 cupom **CUPOM50** | Trilha completa R$ 39,99 cupom **SEGUIDOR80** | @devopsraiz | #devopsraiz #devops #cloud #devjr #carreiratech
- **Trilha sonora:** lo-fi tech trending 60-90 BPM
- **Texto na tela (overlay):**
    - 0:00-0:03 — "Kubernetes assusta? Pensa numa orquestra de músicos." (white sobre dark, font bold)
