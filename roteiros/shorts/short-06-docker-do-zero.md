# SHORT 06 — Docker em 10 segundos
...
- **Titulo Short:** Docker em 10 segundos
- **Caption:** Funciona na sua máquina mas quebra na do colega? | Container = pacote zip da sua app. Roda igual em qualquer máquina. | PDF de apoio R$ 4,95 cupom **CUPOM50** | Trilha completa R$ 39,99 cupom **SEGUIDOR80** | @devopsraiz | #devopsraiz #devops #cloud #devjr #carreiratech
- **Trilha sonora:** lo-fi tech trending 60-90 BPM
- **Texto na tela (overlay):**
    - 0:00-0:03 — "Funciona na sua máquina mas quebra na do colega?" (white sobre dark, font bold)
